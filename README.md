# 🧰 AI 工具箱 · Awesome AI Toolbox

> 每日从 Twitter 精选的 GitHub AI 项目收藏夹｜中文介绍 · 分类标签 · 持续更新
>
> 🔔 同步发布：Twitter [@Thuweni1](https://x.com/Thuweni1) · 小红书 @Ai.BabyChang
...
> AI 赚钱项目百科全书，389 个能用 AI 做产品、自动化和变现的开源项目。

- 🏷️ 标签：`变现` · `项目合集`
- 📅 收录：2026-08-25 · [原帖](https://x.com/goan999999/status/2092246992617615802)

### [Agent-Reach](https://github.com/Panniantong/Agent-Reach) ⭐75k+
> 给 AI Agent 装上全网眼睛。Twitter、Reddit、YouTube、B站、小红书一键读取，零 API 费用。

- 🏷️ 标签：`联网` · `情报`
- 📅 收录：2026-08-25 · [原帖](https://x.com/goan999999/status/2092246992617615802)

### [ClawWork](https://github.com/HKUDS/ClawWork)
> AI 打工经济测试框架，实测 Agent 时薪 2285 美元。

- 🏷️ 标签：`Agent经济` · `评测`
- 📅 收录：2026-08-25 · [原帖](https://x.com/goan999999/status/2092246992617615802)

### [goose](https://github.com/block/goose) ⭐53k+
> 开源「AI 程序员」，一句话搭项目、装依赖、写代码、跑测试。

- 🏷️ 标签：`AI编程` · `自动化开发`
- 📅 收录：2026-08-25 · [原帖](https://x.com/goan999999/status/2092246992617615802)

### [superpowers](https://github.com/obra/superpowers) ⭐277k+
> 把整套软件开发流程 Skill 化，让 Agent 按成熟流程干活。

- 🏷️ 标签：`工作流` · `AI编程`
- 📅 收录：2026-08-25 · [原帖](https://x.com/goan999999/status/2092246992617615802)

### [Agent Skills (Claude)](https://github.com/anthropics/skills)
> Claude Code 官方技能库，常用操作封装成可复用指令。
...
### [MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo) ⭐116k+
> AI 一键生成短视频，真正能赚钱的内容生产线。

- 🏷️ 标签：`短视频` · `内容生产`
- 📅 收录：2026-08-25 · [原帖](https://x.com/goan999999/status/2092246992617615802)

### [火宝短剧 (huobao-drama)](https://github.com/chatfire-AI/huobao-drama) ⭐13.8k
> 短剧全自动流水线：剧本、分镜、配音、合成，Docker 一键起，10分钟出片。

- 🏷️ 标签：`短剧` · `全自动`
- 📅 收录：2026-08-25 · [原帖](https://x.com/bkdgiffug/status/2092161556809232501)

### [Toonflow](https://github.com/HBAI-Ltd/Toonflow-app) ⭐13.5k
> 专治小说改漫剧，三层 Agent 保角色一致性。

- 🏷️ 标签：`漫剧` · `小说改编`
- 📅 收录：2026-08-25 · [原帖](https://x.com/bkdgiffug/status/2092161556809232501)

### [waoowaoo](https://github.com/waooAI/waoowaoo) ⭐13.5k
> 工业级全自动 AI 短剧，剧本到成片全包，已有人拿它接单。

- 🏷️ 标签：`短剧` · `接单变现`
- 📅 收录：2026-08-25 · [原帖](https://x.com/bkdgiffug/status/2092161556809232501)

### [魔因漫创 (moyin-creator)](https://github.com/MemeCalculate/moyin-creator) ⭐4k+
> 对接 Seedance 2.0 的量产工具，多任务并行、角色锚点防漂移。

- 🏷️ 标签：`番剧` · `量产`
- 📅 收录：2026-08-25 · [原帖](https://x.com/bkdgiffug/status/2092161556809232501)

### [HyperFrames](https://github.com/heygen-com/hyperframes)
> HeyGen 开源的视频生成引擎，一句话生成视频。
...
### [LibreChat](https://github.com/danny-avila/LibreChat) ⭐40k+
> 一个界面自由切换 ChatGPT、Claude、Gemini、DeepSeek 和本地模型，docker 一行起。

- 🏷️ 标签：`多模型` · `自部署`
- 📅 收录：2026-08-25 · [原帖](https://x.com/bkdgiffug/status/2091799420551717139)

---

## 📊 金融数据

### [Financial-API (同花顺官方)](https://github.com/HiThink-Tech/Financial-API)
> 同花顺官方 A 股数据服务：行情、K线、龙虎榜、财报，API/MCP/CLI/Python 全支持。

- 🏷️ 标签：`A股` · `量化`
- 📅 收录：2026-08-25 · [原帖](https://x.com/yiyirats/status/2091825341278851328)
...
> 量化技能包：查行情、拉财务、跑回测，装进 Claude Code/OpenClaw 直接说人话调用。
...
### [FreeLLMAPI](https://github.com/tashfeenahmed/freellmapi) ⭐20k
> 34 家平台 635 个免费模型接口聚合成一个 /v1，额度用完自动切下一家。

- 🏷️ 标签：`免费API` · `额度聚合`
- 📅 收录：2026-08-25 · [原帖](https://x.com/huoshan007/status/2092115568686145893)

### [12个付费AI工具免费平替清单](https://x.com/mr_blackmirror/status/2091901140447511011)
> ChatGPT→DeepSeek、Midjourney→SD 等12组付费工具免费平替
...
> 把 Claude Code 变成统一遥控器，吃各家免费额度。语音留言转文字直接出代码。
...
### [markitdown](https://github.com/microsoft/markitdown) ⭐176k+
> 微软文档预处理神器：PDF/Word/PPT/Excel/音视频一键转 Markdown 喂给 LLM。

- 🏷️ 标签：`文档处理` · `微软`
- 📅 收录：2026-08-25 · [原帖](https://x.com/goan999999/status/2092246992617615802)

### [Firecrawl](https://github.com/firecrawl/firecrawl)
> 丢一个 URL 进去，整站变成结构化数据吐出来，JS 渲染的动态页照样扒。

- 🏷️ 标签：`爬虫` · `数据采集`
- 📅 收录：2026-08-25

### [crawl4ai](https://github.com/unclecode/crawl4ai) ⭐70k+
> 专门给 LLM 做的爬虫，网页直接转成大模型爱吃的干净文本，免费无 key。7万星。

- 🏷️ 标签：`爬虫` · `LLM`
- 📅 收录：2026-08-25

### [browser-use](https://github.com/browser-use/browser-use) ⭐100k+
> 让 AI 像真人一样操作浏览器：点击、登录、填表。ETH 学生作品，10万星。

- 🏷️ 标签：`浏览器自动化` · `AI`
- 📅 收录：2026-08-25

### [Crawlee](https://github.com/apify/crawlee)
> 代理轮换、自动重试、指纹伪装、队列调度，反爬护甲一次配齐。

- 🏷️ 标签：`爬虫` · `反爬`
- 📅 收录：2026-08-25

### [Scrapy](https://github.com/scrapy/scrapy)
> 爬虫界的活化石，百万级页面扛得住，免费开源，教程一搜一大把。

- 🏷️ 标签：`爬虫` · `老牌`
- 📅 收录：2026-08-25

### [Scrapling](https://github.com/D4Vinci/Scrapling)
> 网站改版后元素能自动找回，脚本不用重写，免费不输付费货。

- 🏷️ 标签：`爬虫` · `自愈`
- 📅 收录：2026-08-25

### [scrcpy](https://github.com/Genymobile/scrcpy) ⭐140k+
> 电脑直接控制安卓机，专治只有 App 没有网页的顽固数据源。14万星。

- 🏷️ 标签：`安卓` · `投屏控制`
- 📅 收录：2026-08-25

### [AutoScraper](https://github.com/alirezamika/autoscraper)
> 喂几个例子它就自己悟出抓取规则，选择器一行不用手写。

- 🏷️ 标签：`爬虫` · `机器学习`
- 📅 收录：2026-08-25

### [curl-impersonate](https://github.com/lwthiker/curl-impersonate)
> 把 curl 的指纹伪装成真浏览器，服务端根本看不出你是脚本。

- 🏷️ 标签：`反爬` · `指纹伪装`
- 📅 收录：2026-08-25

### [Nango](https://github.com/NangoHQ/nango)
> 开源 API 集成平台，连接数百个第三方服务。

- 🏷️ 标签：`API集成`
- 📅 收录：2026-08-25

### [Agentic Inbox](https://github.com/cloudflare/agentic-inbox)
> Cloudflare 的 AI 邮件助手，自动读邮件提炼要点。

- 🏷️ 标签：`邮件` · `AI助手`
- 📅 收录：2026-08-25

### [Coolify](https://github.com/coollabsio/coolify) ⭐60k+
> 开源自托管 PaaS，帮人省 Vercel 费用还能收管理费。6万+星。

- 🏷️ 标签：`自托管` · `PaaS`
- 📅 收录：2026-08-25

### [n8n](https://github.com/n8n-io/n8n) ⭐170k+
> 工作流自动化平台，给企业搭流程收设置费+月维护费。17万+星。

- 🏷️ 标签：`自动化` · `工作流`
- 📅 收录：2026-08-25

### [dembrandt](https://github.com/dembrandt/dembrandt) ⭐2.9k
> 2.9k star，TypeScript 写的，更新很勤。

- 🏷️ 标签：`CLI工具`
- 📅 收录：2026-08-25

### [MultiPost-Extension](https://github.com/leaperone/MultiPost-Extension)
> 一个浏览器扩展搞定全平台分发，不用再当复制粘贴机器人。

- 🏷️ 标签：`内容分发` · `浏览器扩展`
- 📅 收录：2026-08-25

### [yichen-skills](https://github.com/mcncarl/yichen-skills)
> 含 yichen-asr 语音转写：阶跃 Step ASR（一小时一毛五）+ 火山豆包 ASR（一小时一块钱）。
...
### [Video Ocean](https://github.com/hpcaitech/Open-Sora)
...
### [XHS Note Generator](https://github.com/whotto/Video_note_generator)
...
### [Comfyui_Object_Migration](https://github.com/TTPlanetPig/Comfyui_Object_Migration)
...
### [EveryoneNobel](https://github.com/16131zzzzzzzz/EveryoneNobel)
> 一款开源的 AI 工具，可用于生成个性化诺贝尔奖项图片，利用 ComfyUI 进行图像生成，并结合 HTML 模板展示图片上的文本，只需提供个人肖像图即可生成诺贝尔奖项风格图像。

- 🏷️ 标签：`AI工具` · `GitHubDaily精选`
- 📅 收录：2026-08-26 · [原帖](https://github.com/GitHubDaily/GitHubDaily)

### [PodCastLM](https://github.com/YOYZHANG/PodCastLM)
...
### [Virtual Try-On Application](https://github.com/adarshb3/Virtual-Try-On-Application-using-Flask-Twilio-and-Gradio)
> 一款基于 WhatsApp API 和 IDM - VTON 虚拟试穿模型的 AI 应用，用户只需在 WhatsApp 上传个人照片和服装照片，即可生成虚拟试穿效果图，提供便捷的虚拟试衣体验。

- 🏷️ 标签：`AI工具` · `GitHubDaily精选`
- 📅 收录：2026-08-26 · [原帖](https://github.com/GitHubDaily/GitHubDaily)

### [Claude Financial Data Analyst](https://github.com/anthropics/anthropic-quickstarts/tree/main/financial-data-analyst)
...
### [OpenScanner](https://github.com/pencilresearch/OpenScanner)
> 一款快速、易用且开源免费的文档扫描工具，具有自动文本识别、文档命名、地理位置标记、签名添加、Vision Pro 支持等功能，可保存、编辑、注释和分享扫描文档。

- 🏷️ 标签：`AI工具` · `GitHubDaily精选`
- 📅 收录：2026-08-26 · [原帖](https://github.com/GitHubDaily/GitHubDaily)

### [wcf.js](https://github.com/wechatferry/wechatferry)
...
### [HivisionIDPhoto](https://github.com/Zeyi-Lin/HivisionIDPhotos)
...
### [Product Hunt Daily Hot](https://github.com/ViggoZ/producthunt-daily-hot)
...
### [Llama Tutor](https://github.com/Nutlope/llamatutor)
...
### [Kspider](https://github.com/kkangert/kspider)
...
### [Whisper Timestamped](https://github.com/xenova/transformers.js/tree/v3/examples/whisper-word-timestamps)
...
### [Diffutoon](https://github.com/modelscope/DiffSynth-Studio/blob/main/examples/Diffutoon/README.md)
...
### [AI Math Notes](https://github.com/ayushpai/AI-Math-Notes)
...
### [Talk With Gemini](https://github.com/Amery2010/TalkWithGemini)
...
### [Claude-Journalist](https://github.com/mshumer/ai-journalist)
...
### [Comflowy](https://github.com/6174/comflowyspace)
...
### [StickerBaker](https://github.com/fofr/cog-stickers)
...
### [AI红包封面生成器](https://github.com/all-in-aigc/aicover)
...
### [Auto Job Find Assistant](https://github.com/Frrrrrrrrank/auto_job__find__chatgpt__rpa)
...
### [IP Helper](https://github.com/soulteary/ip-helper)
...
### [academic-project-page-template-vue](https://github.com/JunyaoHu/academic-project-page-template-vue)
...
### [Your Next Store](https://github.com/yournextstore/yournextstore)
...
### [NewsNow](https://github.com/newsapp/newsnow)
...
### [123pan](https://github.com/Bao-qing/123pan)
...
### [cloudflare-saas-stack](https://github.com/Dhravya/cloudflare-saas-stack)
...
### [Fideo](https://github.com/chenfan0/fideo-live-record)
...
### [Auto-SSL](https://github.com/danbao/auto-ssl)
...
### [ShotEasy](https://github.com/CH563/shot-easy-website)
...
### [Telegram Media Downloader](https://github.com/Neet-Nestor/Telegram-Media-Downloader)
...
### [Douyin-Vue](https://github.com/zyronon/douyin)
...
### [Vmail.DEV](https://github.com/yesmore/vmail)
...
### [ChatGPT Source Watch](https://github.com/0xdevalias/chatgpt-source-watch)
...
### [China Holiday Calendar](https://github.com/lanceliao/china-holiday-calender)
...
### [Cloud Document Converter](https://github.com/lujunji4113/cloud-document-converter)
...
### [ComfyUI_Bxb](https://github.com/zhulu111/ComfyUI_Bxb)
...
### [Reborn AI](https://github.com/Christopher-Hayes/vscode-chatgpt-reborn)
...
### [cat-catch (猫抓)](https://github.com/xifangczy/cat-catch)
> 一款开源免费的网页资源嗅探插件，能够筛选列出当前页面的资源，提供嗅探、缓存捕捉、视频录制等工具帮助抓取资源，支持自定义抓取资源类型。

- 🏷️ 标签：`浏览器插件` · `GitHubDaily精选`
- 📅 收录：2026-08-26 · [原帖](https://github.com/GitHubDaily/GitHubDaily)

### [Responsive Viewer](https://github.com/skmail/responsive-viewer)
...
### [《理解深度学习》中文版](https://github.com/careywyr/UnderstandingDeepLearning-ZH-CN)
...
### [深入超高可用架构原理与实践](https://github.com/isno/theByteBook)
...
### [Stable Diffusion From Scratch](https://github.com/juraam/stable-diffusion-from-scratch)
> 一套系统性的教程，讲解 Stable Diffusion 和扩散模型的工作原理及其背后的数学知识，并提供一系列步骤指导训练完成一个扩散模型。

- 🏷️ 标签：`教程` · `GitHubDaily精选`
- 📅 收录：2026-08-26 · [原帖](https://github.com/GitHubDaily/GitHubDaily)

### [From Tensor to Stable Diffusion](https://github.com/jla524/fromthetensor)
...
### [AI Text-to-Video Model from Scratch](https://github.com/FareedKhan-dev/AI-text-to-video-model-from-scratch)
...
### [PyTorch Deep Learning Tutorial](https://github.com/mrdbourke/pytorch-deep-learning)
...
### [《大语言模型》电子书籍](https://github.com/LLMBook-zh/LLMBook-zh.github.io)
...
### [SQL之母](https://github.com/liyupi/sql-mother)
> 一个免费的闯关式 SQL 自学网站，通过有趣的交互式关卡，让初学者从 0 到 1 掌握常用 SQL 语法，包括 30 多个关卡、在线提交代码、自由选择关卡、自定义关卡等功能。

- 🏷️ 标签：`教程` · `GitHubDaily精选`
- 📅 收录：2026-08-26 · [原帖](https://github.com/GitHubDaily/GitHubDaily)

### [Hugging Face AI Courses](https://github.com/huggingface/course)
...
### [web3.0](https://github.com/wangschang/web3.0)
...
### [m3u直播源收集列表](https://github.com/YanG-1989/m3u)
...
### [awesomeMLSys](https://github.com/cuda-mode/awesomeMLSys)
...
### [ComfyUI-Yolain-Workflows](https://github.com/Yolain-Codes/ComfyUI-Yolain-Workflows)
...
### [IPTV Channels Collection](https://github.com/iptv-org/iptv)
> 一份收集了世界各地公开的 IPTV 频道集合，涵盖动画、商业、教育、历史、电影、音乐、科学等多种类别，并按语言、国家、地区进行分组。

- 🏷️ 标签：`资料合集` · `GitHubDaily精选`
- 📅 收录：2026-08-26 · [原帖](https://github.com/GitHubDaily/GitHubDaily)

### [awesome-social-media-downloader](https://github.com/DangJin/awesome-social-media-downloader)
...
### [best-practice](https://github.com/saasfly/best-practice)
...
### [categorized-raycast-extensions](https://github.com/marekbrze/categorized-raycast-extensions)
...
### [ComfyUI Workflows](https://github.com/ZHO-ZHO-ZHO/ComfyUI-Workflows-ZHO)
> 一份包含 36 个 ComfyUI 工作流的开源合集，涵盖 14 大类别，如 Stable Cascade、3D、LLM + SD、Portrait Master、SVD 等，为 ComfyUI 学习者提供参考。

- 🏷️ 标签：`资料合集` · `GitHubDaily精选`
- 📅 收录：2026-08-26 · [原帖](https://github.com/GitHubDaily/GitHubDaily)

### [rectg](https://github.com/jackhawks/rectg)
...
### [Awesome-Love-Code](https://github.com/sun0225SUN/Awesome-Love-Code)
> 一份收集了 50 多份表白代码的代码库，为程序员提供浪漫的表白方式。

- 🏷️ 标签：`资料合集` · `GitHubDaily精选`
- 📅 收录：2026-08-26 · [原帖](https://github.com/GitHubDaily/GitHubDaily)

### [oh-my-foss-android](https://github.com/xlucn/oh-my-foss-android)
...
1. 从 Twitter 精选的 GitHub 项目（AI/编程/效率方向）
2. 开源、免费或可自部署优先
3. 中文一句话介绍 + 分类标签 + 原帖溯源

## 🔄 更新方式

每次双平台（Twitter @Thuweni1 + 小红书 @Ai.BabyChang）同步发布后，自动入库更新本仓库。

## 📄 License

CC BY-NC-SA 4.0（转载注明出处）
